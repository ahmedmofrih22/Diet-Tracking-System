...
class Abdominal_CircumferenceController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('Categore.children.Abdominal_Circumference.Add_Abdominal_Circumference', compact('Client', 'Categore'));
    }
    ...
    public function edit($id)
    {
        ...
        $Client = Client::all();
        return view('Categore.children.Abdominal_Circumference.edit', compact('Client', 'Abdominl', 'Categore'));
    }
