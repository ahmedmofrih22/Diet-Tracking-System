...
class Fat_PercentageController extends Controller
{
    ...
    public function create()
    {
        ...
        $Client = Client::all();
        return view('Categore.children.Fat_Percentage.Add_Fat_Percentage', compact('Client', 'Categore'));
    }
    ...
    public function edit($id)
    {
        ...
        $Client = Client::all();
        return view('Categore.children.Fat_Percentage.edit', compact('Categore', 'Fat_Percentage', 'Client'));
    }
