...
class Abdominal_CircumferenceController extends Controller
{
    ...
    public function create()
    {
        ...
        $Client = Client::all();
        return view('Categore.Elderly.Abdominal_Circumference.Add_Abdominal_Circumference', compact('Client', 'Categore'));
    }
    ...
    public function edit($id)
    {
        ...
        $Client = Client::all();
        return view('Categore.Elderly.Abdominal_Circumference.edit', compact('Client', 'Abdominl', 'Categore'));
    }
