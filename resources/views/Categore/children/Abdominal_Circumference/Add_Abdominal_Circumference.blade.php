            ...
            <div class="card-body">
                <div class="col-lg-12 margin-tb">
                    <div class="pull-right">
                        <a class="btn btn-primary btn-sm" href="{{ url('Children.index') }}">back</a>
                    </div>
                </div><br>
                <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2"
                    action="{{ route('Abdominal_Children.store', 'test') }}" method="post">
                    {{ csrf_field() }}
                    ...
                    <b>
                        <b><br>
                            <b><br>
                                ...
                                <div class="row mg-b-20" style="width: 90%">
