                ...
                <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2"
                    ...
                    <div class="row mg-b-20" style="width: 80%">
                        ...
                        <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                            ...
                            <select class="custom-select mr-sm-2" name="Specialization_id" required>
                                <option selected disabled>Choose from the list</option>
                                @foreach ($Specialties as $Specialtie)
                                    <option value="{{ $Specialtie->id }}">{{ $Specialtie->Name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper" style="    left: 67px;">
                            <label for="inputState">Choose from the list:</label>
                        ...
                        <div class="row mg-b-20">
                            <div class="col-xs-12 col-md-12">
                                <div class="form-group">
                                    <label class="form-label">Roles_User</label>
